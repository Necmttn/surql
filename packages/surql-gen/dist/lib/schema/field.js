 ...
 */
function inferSurrealTypeFromAST(ast) {
    switch (ast._tag) {
        case "StringKeyword":
            return "string";
        case "NumberKeyword":
...
const FieldTypeSchema = Schema.Literal("string", "number", "int", "bool", "datetime", "array", "object", "record", "any");
 ...
 * ```
 */
export class SurrealField extends Schema.Class("SurrealField")({
    ...
    static fromSchema(name, schema) {
        ...
        if (schemaStructure._tag === "Transformation" &&
            ...
            schemaStructure.from.types.some((t) => t._tag === "UndefinedKeyword")) {
            isOptional = true;
            // Get the inner schema (non-undefined type)
            const innerType = schemaStructure.from.types.find((t) => t._tag !== "UndefinedKeyword");
            if (innerType) {
